...
public class AsyncTaskUploadActivityFromVisitedPlace extends AsyncTask {
    ...
    public AsyncTaskUploadActivityFromVisitedPlace(Context context, JSONObject JsonGenerator_activity0) {
        super();
