    ...
    private String getTransitionString(int transitionType) {
        switch (transitionType) {
            case Geofence.GEOFENCE_TRANSITION_ENTER:
                return getString(com.i2r.xue.rate_this_place.R.string.geofence_transition_entered);
            case Geofence.GEOFENCE_TRANSITION_EXIT:
                return getString(com.i2r.xue.rate_this_place.R.string.geofence_transition_exited);
            default:
                return getString(com.i2r.xue.rate_this_place.R.string.unknown_geofence_transition);
        }
    }
